          ...
          <div className="flex-1">
            ...
            >
              ...
              >
                ...
                <GlassContainer
                  depth="deep"
                  className="flex-1 overflow-hidden p-0 border border-blue-800/30 shadow-lg"
                  withNoise
                >
                  {proxies.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-[200px]">
                      <p className="text-foreground">No proxies available</p>
                      <Button
                        variant="outline"
                        size="sm"
                        className="mt-4 border border-blue-800/30"
                        onClick={handleFetchProxies}
                        disabled={isLoading}
                      >
                        <RefreshCw
                    ...
                    <div className="flex flex-col">
                      <Table>
                        <TableHeader className="glass-surface border-b-2 border-blue-700/50">
                          <TableRow>
                            <TableHead className="text-foreground font-semibold text-sm bg-blue-800/80 py-3">
                              Proxy URL
                            </TableHead>
                            <TableHead className="w-[140px] text-foreground font-semibold text-sm bg-blue-800/80 py-3">
                              Last Used
                            </TableHead>
                          </TableRow>
                        </TableHeader>
                        <TableBody>
                          {proxies.slice(0, 10).map((proxy, index) => (
                            <TableRow
                              key={proxy.id}
                              className={`
                                transition-colors hover:bg-blue-800/40
                                ${
                                  index % 2 === 0
                                    ? "bg-blue-950/30"
                                    : "bg-blue-900/20"
                              ...
                              `}
                            >
                              <TableCell className="font-mono text-sm font-medium text-foreground border-b border-blue-800/30 py-2.5">
                              ...
                              <TableCell className="text-sm text-foreground border-b border-blue-800/30 py-2.5">
                                {proxy.lastUsed
                                  ? formatDistanceToNow(
                  ...
                  <div className="px-4 py-4 text-sm font-bold text-foreground flex items-center justify-between bg-blue-700/70 border-t border-blue-600/60 shadow-inner">
                    <div className="flex items-center">
                      <span className="mr-1">Showing</span>
                      <span className="px-1.5 py-0.5 mx-1 bg-blue-500/30 rounded text-blue-100">
                    ...
                    {proxies.length > 10 && (
                      <span className="text-xs px-2.5 py-1 rounded-full bg-blue-500/60 text-white font-medium shadow-sm">
